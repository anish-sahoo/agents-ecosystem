...
access: read-only
model_tier: default
description: Turns a goal and code context into a concrete, ordered implementation plan with named files, acceptance criteria, and risks. Read-only — plans, never edits. Use before non-trivial features or refactors.
---
