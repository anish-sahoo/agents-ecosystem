...
access: read-only
model_tier: default
description: Security auditor focused on auth, authorization, input validation, data exposure, cryptography, and configuration. Inspects code read-only and reports severity-ranked findings with file:line evidence and fixes. Use in parallel security sweeps or for a focused audit of a change.
---
