...
access: read-only
model_tier: default
description: Autonomous web researcher. Searches, evaluates, and synthesizes a focused, well-sourced brief answering a question. Use when a decision depends on external docs, library/API behavior, specs, benchmarks, or recent changes. Read-only.
---
