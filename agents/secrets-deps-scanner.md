---
name: secrets-deps-scanner
kind: subagent
access: read-only
model_tier: default
description: Scans for hardcoded secrets/credentials and vulnerable, outdated, or risky dependencies (supply-chain). Read-only — reports findings with file:line and remediation, never edits. Use in parallel security sweeps or before a release.
---
